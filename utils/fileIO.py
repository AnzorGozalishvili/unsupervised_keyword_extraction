...
def get_duc2001_data(file_path="data/SIFRankEval/DUC2001"):
...
def get_inspec_data(file_path="data/SIFRankEval/Inspec"):
    data = {}
    labels = {}
    for dirname, dirnames, filenames in os.walk(file_path):
        for fname in filenames:
...
def get_semeval2017_data(data_path="data/SIFRankEval/SemEval2017/docsutf8", labels_path="data/SIFRankEval/SemEval2017/keys"):
    data = {}
    labels = {}
