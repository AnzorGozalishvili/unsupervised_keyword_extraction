...
class EmbedRankTransformers:
    ...
    def extract_keywords(self, text: str) -> Tuple[str, list, list]:
        """Finds top keywords and their relevance scores to text (high score means high relevance)"""
        keywords, keyword_relevance, aliases = self.keyword_relevance(text)
        result = [(keyword, relevance) for (keyword, _, _), relevance in zip(keywords, keyword_relevance)]
