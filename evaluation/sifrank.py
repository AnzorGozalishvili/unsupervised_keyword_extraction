...
class SIFRank(object):
    def __init__(self, numOfKeywords, pathData, dataset_name, normalization):
        ...
        self.__keywordsPath = self.__pathData + '/Keywords/SIFRank/' + self.__dataset_name
        self.__outputPath = self.__pathData + "/conversor/output/"
        self.__algorithmName = "SIFRank"
        self.__url = "http://0.0.0.0:5001/sifrank"
    ...
    def runSingleDoc(self, doc):
        try:
            ...
            result = requests.post(self.__url, json=data)
